"""
XGBoost baseline for tabular IDS datasets.
"""
...
def main():
    parser = argparse.ArgumentParser(description="XGBoost IDS baseline")
    ...
    output_path = Config.RESULTS_DIR / f"xgboost_baseline_{suffix}_seed{args.seed}.json"

...
NSL-KDD remains useful for controlled ablation, but it is not sufficient as a standalone modern benchmark. We therefore center the main modern evaluation on UNSW-NB15 and CIC-IDS2017, following recent concerns on dataset obsolescence and cross-dataset validity in IDS research \cite{cantone2024crossdataset, datasetreview2025}.

...
Table~\ref{tab:cic_random} reports the random-split results. Here, all three tree-based baselines nearly saturate the benchmark, while LSTM-IDS remains very strong. Route C improves substantially over the old RL line, but the gain from FT-Transformer over BiAT-MLP is small on this dataset, and neither route-C model approaches the boosted-tree baselines.
...
\begin{table}[h]
    ...
    \begin{tabular}{lcccc}
        ...
        BiAT-FTTransformer & 97.90\% & 78.10\% & 86.88\% & 6.82\% \\

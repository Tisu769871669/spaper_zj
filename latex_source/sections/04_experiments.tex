...
Table~\ref{tab:main_results_unsw} presents the more challenging UNSW-NB15 results. Here, the ranking changes substantially. The original Bi-ARL remains highly unstable, whereas the route-C models are clearly stronger. In particular, BiAT-FTTransformer improves over BiAT-MLP by nearly two F1 points and reduces mean FPR by more than seven points, while still remaining behind the boosted-tree baselines.
...
\begin{table}[h]
    ...
    \begin{tabular}{lcccc}
        ...
        BiAT-FTTransformer & 92.54\% & 84.34\% & 88.24\% & 21.11\% \\
